package com.upskill.basics.java.basics_of_oop.task5.action;

import com.upskill.basics.java.basics_of_oop.task5.builder.CandyPresentBuilder;
import com.upskill.basics.java.basics_of_oop.task5.builder.PresentDirector;
import com.upskill.basics.java.basics_of_oop.task5.entity.*;
...
public class CustomerAction {
    ...
    private static List<Product> readCandyFile() {
        ...
        String filePath = "src/com/upskill/basics/java/basics_of_oop/task5/data/candies.txt";
        try {
